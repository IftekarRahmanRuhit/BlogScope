      ...
      <nav className="bg-gradient-to-r from-blue-600 to-purple-700 p-4 shadow-lg ">
        <div className="container w-11/12 mx-auto flex justify-between items-center relative">
          ...
          <div className="dropdown dropdown-end md:hidden">
            ...
            >
              <p>
                <Link href="/" className="ml-4 mt-3 font-semibold">
                  Home
                </Link>
              </p>

              <p>
                <Link href="/profile" className="ml-4 mt-3 font-semibold">
                  Profile
                </Link>
              </p>
              ...
              {user ? (
                <LogoutLink>
                  <p className="ml-4 mt-2 font-semibold">Logout</p>
                </LogoutLink>
              ) : (
                <>
                  <LoginLink>
                    <p className="ml-4 font-semibold">Sign In</p>
                  </LoginLink>

                  <RegisterLink>
                    <p className="ml-4 mt-2 font-semibold">Sign Up</p>
                  </RegisterLink>
                </>
              )}
            </div>
